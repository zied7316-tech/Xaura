...
// Protected routes - Worker or Owner with worksAsWorker (must be before /:id to avoid route conflict)
router.get('/my-services', protect, authorize('Worker', 'Owner'), getMyServices);
